...
2.  **Accuracy calculation** - Edits to required fields are “major
    edits”
3.  **Record completeness** - Records without required fields may be
    rejected

### Guidelines for Required Fields

**Mark as required:** - Core identifying information (organism names,
dates, locations) - Evidence fields
(`all_supporting_source_sentences`) - Fields needed for deduplication

**Mark as optional:** - Descriptive details that may not always be
