...
By default, ecoextract uses `anthropic/claude-sonnet-4-5`. To use a
different provider, pass the `model` parameter to
[`process_documents()`](https://n8layman.github.io/ecoextract/reference/process_documents.md).
Note: non-Anthropic providers have not been fully tested.
