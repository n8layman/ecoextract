...
ecoextract supports multiple LLM providers (Anthropic Claude, OpenAI GPT, Mistral). Schemas must follow [OpenAI's structured output requirements](https://platform.openai.com/docs/guides/structured-outputs/supported-schemas) to work across all providers:
