...
For a complete explanation of how accuracy is calculated and why, see [ACCURACY.md](../ACCURACY.md).

Accuracy visualizations (confusion matrices, heatmaps) are available in the [ecoreview](https://github.com/n8layman/ecoreview) Shiny app.
