...
- Mistral (OCR or extraction fallback): <https://console.mistral.ai/>
...
EcoExtract supports multiple OCR providers through [ohseer](https://github.com/n8layman/ohseer). By default it uses Tensorlake, but you can switch to Mistral or Claude, or use provider fallback:
