...
vignette: >
  %\VignetteIndexEntry{Testing Philosophy}
...
To include integration tests, set up API keys in a `.env` file (see the [Complete Guide](ecoextract-workflow.html#api-key-setup) for details). The `.env` file is automatically loaded when R starts in the project directory.
